...
# Header
_sep
echo "Setup ML4W Dotfiles Welcome"
...
wget -q -P "$HOME/.cache" "https://github.com/mylinuxforwork/dotfiles-welcome/releases/latest/download/com.ml4w.welcome.flatpak"
cd "$HOME/.cache"
echo ":: Installing com.ml4w.welcome.flatpak"
eval "flatpak --user -y --reinstall install com.ml4w.welcome.flatpak > $cmdoutput"
rm "$HOME/.cache/com.ml4w.welcome.flatpak"
